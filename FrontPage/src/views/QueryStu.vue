<template>
  <div class="query-stu">
    <h3 v-show="!ifShowDetail">管理学生作业</h3>
...
export default {
  ...
  methods: {
    ...
    handleShow(index, row) {
      ...
      getStuDetail(params)
        .then((res) => {
          //closeDebug console.log("-----------获取个人作业详情---------------");
          let obj = JSON.parse(res.msg);
    ...
    onQuery() {
      ...
      params.append("order", this.orderMode); //作业名
      params.append("field", this.orderField); //作业名
      getStuWorkList(params)
        .then((res) => {
