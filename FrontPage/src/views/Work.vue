<template>
  <div class="work">
    ...
    <el-dialog title="编辑作业" :visible.sync="ifShowUpdateDialog" width="90%">
      <span>正在编辑：{{ selectwork.WorkName }}</span>
      <div style="margin: 10px 0;"></div>
      <el-form label-position="left" label-width="100px">
        <el-form-item label="作业截止时间" prop="newContent"
          ><el-input
            type="textarea"
            placeholder="请输入内容"
  ...
  data() {
    return {
      ...
      Columns: [
        ...
        { name: "开始日期", value: "createAt", width: "180", ifShow: true },
        { name: "截止日期", value: "DeadLine", width: "180", ifShow: true },
      ],
      currentPage: 1,
      pageSize: 10,
      tableData: [{}], //展示的数据
